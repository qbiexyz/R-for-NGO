...
head(iris$Sepal.Width) ## 顯示Sepal.Width前6筆資料
head(sort(iris$Sepal.Width)) ## 顯示排序之後的Sepal.Width前6筆資料

head(order(iris$Sepal.Width)) ## 顯示排序之後前6筆資料的原始位置(由小到大)
head(order(iris$Sepal.Width, decreasing = T)) ## 顯示排序之後前6筆資料的原始位置(由大到小)

## 根據排序之後的Sepal.Width前6筆資料的原始位置，來排序整個資料
