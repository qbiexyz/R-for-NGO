...
由於是初步介紹的入門講義，因此會簡單介紹一下R的基礎概念，但部分過於涉及程式設計的部分會稍微略過，重點會放在**如何獲取資料與簡單清理**以及後續**使用資料實作初步統計與視覺化**部分
...
另外也有一些「調查資料」可以免費提供申請下載使用，在台灣多數有公開的調查資料會被整理在[「SRDA學術調查資料庫」](https://srda.sinica.edu.tw/index.php)當中，其中也包括政府每年的調查型資料，兩者都可以提供申請下載使用，但也需注意相關的參考格式/
...
講義後續範例會使用[世界價值觀第七波的台灣調查](https://srda.sinica.edu.tw/datasearch_detail.php?id=3473)，/
資料可在SRDA上下載取得，或是在[此連結]()下載使用
![](picture/WVS_w7.png)

參考:蔡明璋、陳志柔(2023)。物質主義、後物質主義與新政治：世界價值觀第七波的台灣調查與亞洲國家的比較(C00344)【原始數據】取自中央研究院人文社會科學研究中心調查研究專題中心學術調查研究資料庫。https://doi.org/10.6141/TW-SRDA-C00344-1
