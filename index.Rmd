...
講義後續範例會使用[世界價值觀第七波的台灣調查](https://srda.sinica.edu.tw/datasearch_detail.php?id=3473)，資料可在SRDA上下載取得，或是在[此連結](https://github.com/qbiexyz/R-for-NGO/tree/master/data/WVS_w7)下載使用 ![](picture/WVS_w7.png)
